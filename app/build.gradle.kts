plugins {
    ...
    // Added plugins for Gradle services
...
android {
    namespace = "com.cecs491b.thecookout"
    compileSdk = 36

    defaultConfig {
        applicationId = "com.cecs491b.thecookout"
        minSdk = 24
        targetSdk = 36
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    // Hilt + Compose navigation for Hilt
